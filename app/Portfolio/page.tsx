const Page = () => {
  return (
    <div className="flex h-full">
      ...
      <aside className="hidden lg:flex lg:w-1/3 border-r border-zinc-200 p-4 dark:border-zinc-800">
        <div className="w-full">Left Content</div>
      </aside>

      {/* Right Content (Always visible) */}
      <section className="flex-1 p-4 overflow-y-auto">Right Content</section>
      <h1>
